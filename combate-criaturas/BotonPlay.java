...
public class BotonPlay extends Actor {
    ...
    public BotonPlay(String nombre, GreenfootImage image) {
        this.nombre = nombre;
        this.size = size;
        this.color = color;
    ...
    public BotonPlay(String nombre, GreenfootImage image, boolean esEquipoAzul) {
        this.nombre = nombre;
        this.size = size;
        this.color = color;
        this.bgColor = Color.LIGHT_GRAY;
    ...
    public BotonPlay(String nombre, GreenfootImage image, boolean esEquipoAzul, boolean esClickeable) {
        this.nombre = nombre;
        this.size = size;
        this.color = color;
        this.bgColor = Color.LIGHT_GRAY;
